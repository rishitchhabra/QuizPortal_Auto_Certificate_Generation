...
// --- Buttons ----------------------------------------------------------------
const BTN_TONES = { primary: '', secondary: '', ghost: 'btn-ghost', danger: 'btn-danger', dangerOutline: 'btn-danger-outline', success: 'btn-success' };
...
// --- Badges ------------------------------------------------------------------
const BADGE_TONES = { gray: 'badge-gray', blue: 'badge-blue', green: 'badge-green', amber: 'badge-amber', red: 'badge-red' };
